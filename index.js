...
bot.on('message', message => {
    ...
    if(timestamps.has(message.author.id)) {
        ...
        if(now < expirationTime) {
            ...
            return message.reply(`Attends encore ${timeLeft.toFixed(1)} secondes avant de réutiliser \`${command.name}\``);
        }
    }
    ...
    try {
        ...
        console.error(error);
        message.reply('Une erreur est survenue pendant l\'execution de cette commande...');
    }
});
