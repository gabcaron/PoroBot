...
module.exports = {
    name: 'help',
    description: 'Liste toutes les commandes disponibles, ou affiche la description d\'une commande spécifiée.',
    aliases: ['commands'],
    usage: '[command name]',
    cooldown: 5,
        ...
        if(!args.length) {
            ...
            return message.author.send(data, { split: true })
                .then(() => {
                    ...
                    message.reply('Je t\'ai envoyé un message privé avec toutes mes commandes !');
                })
                .catch(error => {
                    console.error(`Could not send help DM to ${message.author.tag}.\n`, error);
                    message.reply('On dirait que je ne peux pas te contacter en privé ...');
                });
        }
